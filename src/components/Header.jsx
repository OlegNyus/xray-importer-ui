...
function Header({
  ...
  const showProjectTabs = isConfigured && visibleProjects.length > 0;

  return (
    <>
      <header className="flex flex-col bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border-b border-gray-200 dark:border-gray-700">
        {/* Main header row */}
        ...
        {/* Project tabs row */}
        {showProjectTabs && (
          <div className="px-3 sm:px-6 pb-3 flex justify-center">
            <ProjectTabs
              projects={projects}
